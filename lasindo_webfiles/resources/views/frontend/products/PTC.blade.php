                    ...
                    <div class="col-12 category-item">
                        ...
                        <div id="brand-products">
                            <div class="content-space to-be-filtered filter-overview ">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row no-margin-bottom">
                                        <h4 class="black" >PTC</h4>
                                    </div>
                                    <div class="form-group row no-margin-top" >
                                        <h4 class="title-overview">Professional Temperature Calibrator</h4>
                                    </div>
                                    <div class="form-group row">
                                        <ul class="text-style">
                                            <li><p>Temperature range from -90 to 660°C (-130 to 1220°F) with 5 models</p></li>
                                            <li><p>Accuracy to ± 0.06°C and Stability to ± 0.01°C</p></li>
                                            <li><p>Clean Dry block calibrator</p></li>
                                            <li><p>Time saving fast cooling and heating times (350° in only 7 minutes)</p></li>
                                            <li><p>“Plug and Play” intelligent reference sensor</p></li>
                                            <li><p>Easy-to-read color display </p></li>
                                            <li><p>Intuitive, fast, user-friendly navigation</p></li>
                            ...
                            <div class="brand-name filter-spesification">
                                <div class="col-lg-12 margin-left-25">
                                    <div class="form-group row no-margin-bottom">
                                        <h4 class="black">PTC</h4>
                                    </div>
                                    <div class="form-group row no-margin-top">
                                        <h4 class="tab-download-a">Professional Temperature Calibrator</h4>
                                    </div>
                                    <div class="form-group row">
                                        <table class="table table-responsive-sm table-bordered">
                                            <tbody>
                                                <tr class="spacer no-border" valign="middle">
                                                    <th class="align-middle lasindo-color" rowspan="13" valign="middle">PTC 125</th>
                                    ...
                                    <div class="form-group row">
                                        <table class="table table-responsive-sm table-bordered">
                                            <tbody>
                                                <tr class="spacer no-border" valign="middle">
                                                    <th class="align-middle lasindo-color" rowspan="13" valign="middle">PTC 155</th>
                                                    <th>Temperature range</th>
                                    ...
                                    <div class="form-group row">
                                        <table class="table table-responsive-sm table-bordered">
                                            <tbody>
                                                <tr class="spacer no-border" valign="middle">
                                                    <th class="align-middle lasindo-color" rowspan="16" valign="middle">PTC 350</th>
                                                    <th>Temperature range</th>
                                    ...
                                    <div class="form-group row">
                                        <table class="table table-responsive-sm table-bordered">
                                            <tbody>
                                                <tr class="spacer no-border" valign="middle">
                                                    <th class="align-middle lasindo-color" rowspan="11" valign="middle">PTC 425</th>
                                                    <th>Temperature range</th>
                                    ...
                                    <div class="form-group row">
                                        <table class="table table-responsive-sm table-bordered">
                                            <tbody>
                                                <tr class="spacer no-border" valign="middle">
                                                    <th class="align-middle lasindo-color" rowspan="15" valign="middle">PTC 660</th>
                                                    <th>Temperature range</th>
                                                    <td>33 to 660°C/91 to 1220°F</td>
                                                </tr>
                                                <tr>
                            ...
                            <div class="brand-name filter-download">
                                <div class="col-lg-12 content-lg-space" >
                                    ...
                                    <div class="form-group row">
                                        <ul class="tab-download-ul">
                                            <li><a href="{{ asset('storage/files/PTC/PTC_125_Datasheet.pdf')}}" class="tab-download-a" download><i class="far fa-file-alt"></i>  PTC 125 Datasheet</li>
                                            <li><a href="{{ asset('storage/files/PTC/PTC_155-350-425-660_Datasheet.pdf')}}" class="tab-download-a" download><i class="far fa-file-alt"></i>  PTC 155/350/425/660 Datasheet</a></li>
                                        </ul> 
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <ul class="tab-download-ul">
                                            <li><a href="{{ asset('storage/files/PTC/PTC_User_Manual.pdf')}}" class="tab-download-a" " download><i class="far fa-file-alt"></i>  PTC User Manual</li>
                                            <li><a href="{{ asset('storage/files/PTC/PTC_Reference_Manual.pdf')}}" class="tab-download-a" download><i class="far fa-file-alt"></i>  PTC Reference Manual</li>
