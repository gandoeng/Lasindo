<header class="c-header c-header-light c-header-fixed">
    ...
    <ul class="c-header-nav d-md-down-none">
        <li class="c-header-nav-item px-3">
            <a class="c-header-nav-link" href="{{ route('frontend.index') }}" data-toggle="tooltip" data-placement="right" title="Visit Website" target="_blank">@lang('Home')</a>
        </li>
        ...
        <li class="c-header-nav-item dropdown">
            <x-utils.link class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <x-slot name="text">
                    ...
                    <span class="ml-2 d-md-down-none">{{ $logged_in_user->name }}</span>
                </x-slot>
            </x-utils.link>
