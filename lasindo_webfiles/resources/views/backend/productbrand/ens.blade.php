...
@section('title', 'Engineering & Solution | Lasindo Administrator' )
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0"><i class="fas fa-wrench"></i> Engineering & Solution</h4>
            </div>
            <div class="col-sm-7">
                    ...
                    <table id="dataTables" class="table">
                        ...
                        <tbody>
                            @php
                                ...
                                foreach($products->where('category','Engineering & Solution') as $pr){
                                    $count = $count + 1;
                            @endphp
                            <tr>
